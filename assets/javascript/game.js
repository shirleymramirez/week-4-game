$(document).ready(function() {
	...
	var redCrystalValue, blueCrystalValue, yellowCrystalValue, greenCrystalValue;
	var wins = 0;
	var losses = 0;
	...
	// listen for clicks on any of the gems by targeting the crystal
	$(".crystal").on("click", function() {
        ...
        if (pressed == "redcyrstal") {
        	userTallyScore += redCrystalValue;
        } else if (pressed == "bluecyrstal") {
        	userTallyScore += blueCrystalValue;
        } else if (pressed == "yellowcyrstal") {
        	userTallyScore += yellowCrystalValue;
        } else if (pressed == "greencyrstal") {
